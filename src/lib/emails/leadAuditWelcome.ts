/**
 * Bienvenida + petición de URL para la "Auditoría Web Express".
 * Disparado desde POST /api/leads cuando entra un lead nuevo.
 */
export function welcomeAuditEmail() {
  const subject = 'Tu Auditoría Web Express 🚀 (Falta un paso)';
