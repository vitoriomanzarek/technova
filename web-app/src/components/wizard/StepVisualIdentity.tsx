import { BookOpen, Image, Sparkles } from 'lucide-react';
...
const identityOptions = [
    { id: 'complete', label: 'Tengo todo', sublabel: 'Brand Manual completo', icon: BookOpen },
    { id: 'logo-only', label: 'Solo Logo', sublabel: 'Tengo logotipo listo', icon: Image },
    { id: 'from-scratch', label: 'Desde Cero', sublabel: 'Necesito crear todo', icon: Sparkles },
];

const StepVisualIdentity = ({ selected, onSelect, onNext, onBack }: StepVisualIdentityProps) => {
    return (
        <div className="space-y-8">
            <div className="flex items-center gap-4">
                <NovaAvatar size="sm" isThinking />
                <div>
                    <h2 className="text-2xl font-bold text-foreground">Identidad Visual</h2>
                    <p className="text-muted-foreground">¿Cómo está tu branding actualmente?</p>
                </div>
            </div>
